<div class="pt-2">
    ...
    <input id="license_number" type="text" 
            ...
            name="license_number" value="{{ old('license_number') }}" required autocomplete="license_number" autofocus>
...
<div class="pt-2">
    ...
    <input id="license_state" type="text" 
            ...
            name="license_state" value="{{ old('license_state') }}" required autocomplete="license_state" autofocus>
...
<div class="pt-2">
    ...
    <input id="license_issue_date" type="date" 
            ...
            name="license_issue_date" value="{{ old('license_issue_date') }}" required autocomplete="license_issue_date" autofocus>
...
<div class="pt-2">
    ...
    <input id="license_expiration_date" type="date" 
            ...
            name="license_expiration_date" value="{{ old('license_expiration_date') }}" required autocomplete="license_expiration_date" autofocus>
